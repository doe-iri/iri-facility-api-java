...
public class IncidentMapping implements Mapping {
    ...
    public static final Map<String, Mapping> RELATIONSHIP_TARGETS = Map.of(
        ...
        Relationships.MAY_IMPACT, new ResourceMapping());
    ...
    // this regex looks for “/incidents/” followed by a 36-char UUID and anchors at end-of-string.
    private static final Pattern PATTERN_UUID =
        Pattern.compile("/incidents/([0-9a-fA-F\\-]{36})$");

    /**
     * Extracts the UUID from any string containing “/incidents/{uuid}” at the end.
     *
     * @param url the full path or URL
     * @return the UUID that followed “/incidents/”
     * @throws IllegalArgumentException if no “/incidents/{uuid}” is found or UUID is malformed
     */
    private static UUID extractId(String url) throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException("Invalid path (must end with /incidents/{uuid}): " + url);
    }
}
