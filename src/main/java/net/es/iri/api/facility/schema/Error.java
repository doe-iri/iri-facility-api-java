...
public class Error {
    @JsonProperty("type")
    @JsonPropertyDescription("A URI reference that identifies the problem type.")
    private URI type;
    ...
    @JsonProperty("status")
    @JsonPropertyDescription("The HTTP status code generated by the origin server for this occurrence of the problem.")
    @Min(100)
    @Max(599)
