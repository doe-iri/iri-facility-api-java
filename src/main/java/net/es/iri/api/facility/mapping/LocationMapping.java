...
public class LocationMapping implements Mapping {
    ...
    // this regex looks for “/locations/” followed by a 36-char UUID and anchors at end-of-string.
    private static final Pattern PATTERN_UUID =
        Pattern.compile("/locations/([0-9a-fA-F\\-]{36})$");

    /**
     * Extracts the UUID from any string containing “/locations/{uuid}” at the end.
     *
     * @param url the full path or URL
     * @return the UUID that followed “/locations/”
     * @throws IllegalArgumentException if no “/locations/{uuid}” is found or UUID is malformed
     */
    private static UUID extractId(String url) throws IllegalArgumentException {
        ...
        throw new IllegalArgumentException("Invalid path (must end with /locations/{uuid}): " + url);
    }
}
