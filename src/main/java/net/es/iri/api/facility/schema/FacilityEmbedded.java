...
public class FacilityEmbedded {
    @JsonProperty("hostedAt")
    private List<Site> hostedAt;

    @JsonProperty("hasLocation")
    private List<Location> hasLocation;
    ...
    private List<Resource> hasResource;
    ...
    public boolean isEmpty() {
        return (hostedAt    == null || hostedAt.isEmpty())
            && (hasLocation == null || hasLocation.isEmpty())
            && (hasIncident == null || hasIncident.isEmpty())
            && (hasEvent    == null || hasEvent.isEmpty())
            && (hasResource == null || hasResource.isEmpty());
    }
}